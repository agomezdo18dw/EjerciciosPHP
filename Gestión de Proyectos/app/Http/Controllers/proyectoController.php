...
class proyectoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $project->fechaIni = $request -> input('fechaIni');
        $project->fechaFin = $request -> input('fechaFin');
        $project->horas = $request -> input('horas');
        $project->responsable = $request -> get('responsable');
        $project->save();
    ...
    {
        $proyecto = Proyecto::find($id);
        return view('proyectos.update')->with(['proyecto' => $proyecto]);
    }
